  ...
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image:linear-gradient(180deg,#960b68 10%,#03113a 100%);">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url(); ?>index.php/UserController/">
        <div class="sidebar-brand-text mx-3" style="text-transform: none !important;font-size: 1.2rem !important;margin-left: 0rem!important;">Soundcrave
        </div>
      ...
      <center>
        <a href="/Soundcrave/index.php/UserController/ShowEditProfile" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-change" style="background-color: #2895b7;border-color: #3495b7;"><i class="fa fa-pencil fa-sm text-white-50"></i> Edit Profile 
        </a>
      </center>
      <br>
      <center>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="background-color: #86467b!important;">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <a href="/Soundcrave/index.php/UserController/Logout" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-change" style="    background-color: #3495b7; border-color: #3495b7;"><i class="fa fa-sign-out fa-sm text-white-50"></i> Logout </a>
            </span>
            </li>
          </ul>
        </nav>
        <div class="container">
        	<br>
			    <h1 id='titlefollowing' class='h3 mb-2 text-gray-800'><b>People who you follow : <b></h1>
          <br> 
          <div class="row">
          <br>
<?php

    if (count($showfollowing) > 0) {
        $counter = 1;
          foreach ($showfollowing as $m) {
            ...
            echo " </span>";
            echo "  <div class='h5 mb-0 font-weight-bold text-gray-800' style='color: #3495b7 !important;'><a href='".$base."index.php/UserController/ShowPublicProfile?username=".$m->getFollowerName()."' style='color:#48b9cd;margin-left: 45px;margin-top: 30px;float: left;' >".$counter." - ".$m->getFollowerName()."</a></div>";
            echo " <br>";
            echo " </div>";
      ...
      echo "<h1>You have no followings found. <br/> Try following some people.</h1>";
    }
?> 
  </div>
</div>
