...
<body>    
 <header class="masthead">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-lg-8 mx-auto text-center">
            <div class="card card-signin my-5" style="margin-top: 18rem!important;">
              <div class="card-body">
                <h5 class="card-title text-center">Create Profile</h5>
                <form name="form" class="form-signin" action="/Soundcrave/index.php/UserController/CreateProfile" method="POST" enctype="multipart/form-data">
                  <div class="form-group text-center " style="position: relative;">
                    <span class="img-div">
                      <div class="text-center img-placeholder" onClick="triggerClick()">
                        <h4>Update image</h4>
                      </div>
                      <img src="<?php echo base_url(); ?>/assets/images/avatar.jpg" onClick="triggerClick()" id="profileDisplay">
                    </span>
                  ...
                  <center>
                    <div class="form-label-group">
                      <div class="multiselect">
                        ...
                        <div id="checkboxes" class="genre-content" style="display: none;float: left;
                              text-align: left;padding: 11px 56px;margin-bottom: 20px;">
                  ...
                  <hr>
                  <center>
                    <button class="col-lg-6 btn btn-lg btn-primary btn-block text-uppercase" type="submit">Create Profile
                    </button>
                  </center>
                </form>
              </div>
  ...
  <div class="space-div" style="height: 200px;background: linear-gradient(to bottom,rgb(22, 22, 22) 0,rgb(22, 22, 22) 75%,#161616 100%);"></div>
